...
return [
    ...
    'nav_envelopes' => 'Struktur Respons',
    'nav_query_params' => 'Parameter Kueri',
    'nav_endpoints' => 'Endpoint',
    'nav_errors' => 'Kode Kesalahan',
    'nav_roadmap' => 'Peta Jalan',

    'authentication_desc' => 'Setiap permintaan harus menyertakan salah satu dari: cookie sesi Sanctum (SPA dengan asal yang sama, setelah masuk melalui web), atau token akses pribadi yang dikirim sebagai header Bearer.',
    ...
    'header_bucket_size' => 'Kapasitas batas',
    ...
    'envelope_error' => 'Struktur kesalahan',
    'envelope_validation' => 'Validasi (422)',

    'query_params_intro_1' => 'mendukung parameter kueri berikut.',
    'query_params_intro_2' => 'menerima',
    'query_params_default_note' => '(bawaan 50, maks. 50).',
    'param_label' => 'Param',
    'type_label' => 'Tipe',
    'notes_label' => 'Catatan',
    'default_label' => 'bawaan',
    'search_notes' => 'Pencarian LIKE pada nama dan deskripsi',
    'province_notes' => 'Harus tersedia di',
    'page_notes' => 'Halaman paginasi',
    'limit_notes' => 'Jumlah data per halaman (bawaan 15)',
    ...
    'roadmap_submit_rating' => 'kirim penilaian',
    'roadmap_comment_lifecycle' => 'kelola komentar',
    'roadmap_forum_endpoints' => 'Endpoint forum',
    'roadmap_replies' => 'balasan',
    'roadmap_user_endpoints' => 'Endpoint pengguna',
    'roadmap_regions' => 'Perincian wilayah administratif — kabupaten/kota, kecamatan, dan desa/kelurahan',
    'roadmap_tokens' => 'Penerbitan token akses pribadi',
];
