        ...
        <div class="hidden md:flex flex-1 items-center justify-end gap-4">
            ...
            @auth
                <div class="relative group">
                    ...
                    <div class="absolute right-0 top-full pt-3 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible group-focus-within:opacity-100 group-focus-within:visible group-focus-within:scale-100 transition-all duration-300 transform origin-top-right group-hover:scale-100 scale-95 z-50">
                    <div class="bg-white border border-gray-200/80 rounded-xl shadow-2xl backdrop-blur-lg overflow-hidden">
