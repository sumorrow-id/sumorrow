<nav class="fixed top-6 left-0 right-0 mx-auto w-[95%] max-w-[1400px] rounded-2xl z-50 flex flex-col bg-[#1A1A1A]/80 border border-white/20 px-6 py-4 text-white backdrop-blur-md shadow-lg transition-all duration-300">
    <div class="flex flex-row justify-between items-center w-full relative">
        <div class="hidden md:flex flex-1 text-l font-bold gap-2">
            <a href="/" class="px-4 py-2 rounded-lg transition hover:bg-[#094174]/20 hover:text-white text-white">Home</a>
            <a href="/explore" class="px-4 py-2 rounded-lg transition hover:bg-[#094174]/20 hover:text-white text-white">Explore</a>
            <a href="#" class="px-4 py-2 rounded-lg transition hover:bg-[#094174]/20 hover:text-white text-white">Community</a>
        </div>
        ...
        <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex justify-center z-10 w-fit pointer-events-none">
            <a href="/" class="pointer-events-auto">
                <img src="{{ asset('images/logo/SUMORROW-LOGO.png') }}" alt="Sumorrow Logo" class="h-10 md:h-12 w-auto transition-transform hover:scale-105" />
            </a>
        </div>
            ...
            @auth
                <div class="relative group">
                    <button class="flex items-center gap-3 focus:outline-none">
                        ...
                        <img src="{{ $avatar ? $src : $defaultAvatar }}" alt="Profile" class="h-10 w-10 rounded-full object-cover border border-white/40">
                    </button>
    ...
    <div id="mobile-menu" class="w-full md:hidden transition-all duration-500 ease-in-out max-h-0 opacity-0 overflow-hidden">
        <div class="flex flex-col gap-4 mt-6 pt-4 border-t border-white/20 text-center pb-2">
            ...
            <div class="pt-4 border-t border-white/10">
                ...
                @else
                    <a href="{{ route('login') }}" class="px-8 py-3 bg-[#094174] text-white font-bold rounded-full transition hover:bg-[#105DA3] mx-auto w-fit">Log in</a>
                @endauth
            </div>
        </div>
    </div>
