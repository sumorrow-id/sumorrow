                ...
                <div class="grow bg-[#F8F9FA] rounded-full flex items-center justify-between px-4 py-2.5 md:py-3">
                    ...
                    <div class="relative flex items-center gap-3 text-gray-400 shrink-0">
                        ...
                        <button type="button" id="btn-image-picker" class="hover:text-[#094174] transition"
                            onclick="document.getElementById('post-image-input').click()" aria-label="Attach images">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            (function() {
                ...
                function rebuildPreview() {
                    ...
                    selectedFiles.forEach(function(file, idx) {
                        ...
                        cell.className =
                            'relative overflow-hidden group rounded-xl border border-gray-200 shadow-sm';
                ...
                function fetchGifs(query) {
                    ...
                    var endpoint = query ?
                        ...
                        query) + '&limit=' + GIPHY_LIMIT + '&rating=g' :
                        'https://api.giphy.com/v1/gifs/trending?api_key=' + GIPHY_API_KEY + '&limit=' + GIPHY_LIMIT +
                        '&rating=g';
...
<script>
    (function() {
        var csrfToken = document.querySelector('meta[name="csrf-token"]')?.getAttribute('content') || document
