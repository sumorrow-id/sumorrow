    ...
    <div class="flex h-screen overflow-hidden">
            ...
            <div class="p-4 border-t border-white/10">
                <div class="flex items-center gap-3 p-2">
                    @if (Auth::user()?->avatar_url)
                        <img src="{{ Auth::user()->avatarUrl() }}" alt="{{ __('common.avatar_alt') }}" onerror="this.onerror=null;this.src='{{ asset('images/placeholder.svg') }}'" class="w-10 h-10 rounded-full border border-white/20">
                    @else
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <header class="relative z-10 bg-white/80 backdrop-blur border-b border-morning-mist/60 h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8 shrink-0">
                ...
                <div class="flex items-center gap-4">
                    <x-locale-switcher
                        button-class="text-blue-bird hover:bg-summit-blue/10 hover:text-summit-blue"
                        active-class="bg-summit-blue/10 text-summit-blue"
                        panel-class="bg-white border-morning-mist/80" />
