        ...
        <div class="w-[95%] max-w-350 mx-auto pt-28 sm:pt-36">
            ...
            <div
                ...
                <div class="absolute -bottom-10 w-[95%] max-w-4xl left-1/2 -translate-x-1/2 z-20">
                    <form action="{{ url('/explore') }}" method="GET"
                        ...
                        <!-- Explore Now Button -->
                        <button type="submit"
                            class="w-full sm:w-auto mt-2 sm:mt-0 px-6 py-2 border border-[#001E3A] text-[#001E3A] font-bold rounded-[1.5rem] hover:bg-[#001E3A] hover:text-white transition duration-300 whitespace-nowrap bg-transparent sm:mr-2 text-sm">
                            Explore Now
                        </button>
                    </form>
                </div>
            ...
            <div class="mt-24 sm:mt-32 mb-20 sm:mb-32 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                <div class="col-span-1 sm:col-span-2 lg:col-span-4 mb-4 sm:mb-8 text-right">
                    ...
                    <h2
                        ...
                        Find Your Perfect Peak<br class="hidden sm:inline"> The Ultimate Guide to Your<br class="hidden sm:inline"> Dream Summit
                    </h2>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-center mb-20 sm:mb-32 relative">
                ...
                <div class="lg:col-span-4 z-10">
                    <h2 class="text-4xl sm:text-5xl font-extrabold text-[#001E3A] mb-6 sm:mb-8 leading-tight">
            ...
            <div
                ...
                <div class="lg:w-1/3 z-10">
                    <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-[#001E3A] mb-4 sm:mb-6">Community</h2>
                    <p class="text-[#001E3A]/70 font-semibold mb-6 sm:mb-8 text-base sm:text-lg">
