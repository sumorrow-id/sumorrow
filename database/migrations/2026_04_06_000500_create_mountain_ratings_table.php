...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($driver === 'sqlite') {
            ...
            DB::unprepared("CREATE OR REPLACE FUNCTION refresh_mountain_avg_rating(mountain_id bigint) RETURNS void AS $$ BEGIN UPDATE mountains SET avg_rating = COALESCE((SELECT AVG(score) FROM mountain_ratings WHERE mountain_id = mountain_id), 0) WHERE id = mountain_id; END; $$ LANGUAGE plpgsql");
    ...
    public function down(): void
    {
        ...
        if ($driver === 'sqlite') {
            ...
            DB::statement('DROP FUNCTION IF EXISTS refresh_mountain_avg_rating(bigint)');
        }
